      ...
      <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-16">
        ...
        <div>
          ...
          <motion.a
            ...
            className="block text-lg font-medium hover:text-purple-400 transition-colors mb-3"
          >
          ...
          >
            <a
              ...
              aria-label="LinkedIn"
              className="flex items-center justify-center w-11 h-11 rounded-full border border-white/10 bg-white/5 text-gray-400 hover:text-white hover:border-white/30 transition-colors"
            >
              <svg
                className="w-5 h-5"
                fill="currentColor"
          ...
          {sent ? (
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              <input
                ...
                required
                placeholder="Name"
                className="bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white placeholder:text-gray-500 outline-none focus:border-purple-500 transition-colors"
              />
              <input
                type="email"
                name="email"
              ...
              <textarea
                ...
                rows={5}
                placeholder="Message"
                className="bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white placeholder:text-gray-500 outline-none focus:border-purple-500 transition-colors resize-none"
              />
              <button
                type="submit"
                className="w-full rounded-lg bg-gradient-to-r from-purple-600 to-pink-600 py-3 text-white font-semibold hover:opacity-90 transition-opacity"
              >
                Send Message
              </button>
            </form>
